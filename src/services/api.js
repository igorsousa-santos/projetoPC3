...
// --- AI API ---
export const aiAPI = {
    generateRecommendations: (prompt, limit, context, { minTracks, maxRetries } = {}) => 
        handleResponse(api.post('/recommendations/generate', { prompt, limit, context, minTracks, maxRetries })),
